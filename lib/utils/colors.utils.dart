...
class AppColors {
  ...
  static final Color mainColor = Color(0xffe81514);
  static final Color scaffoldBackgroundColor = Color(0xffe4b056);
  static final Color scaffoldBackgroundLightColor = Color(0xfff7d493);
